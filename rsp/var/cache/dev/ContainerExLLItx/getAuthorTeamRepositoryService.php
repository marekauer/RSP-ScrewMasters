 ...
 */
class getAuthorTeamRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AuthorTeamRepository' shared autowired service.
     *
     * @return \App\Repository\AuthorTeamRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AuthorTeamRepository.php';

        return $container->privates['App\\Repository\\AuthorTeamRepository'] = new \App\Repository\AuthorTeamRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
