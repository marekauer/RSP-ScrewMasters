 ...
 */
class getHelpDeskTicketRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HelpDeskTicketRepository' shared autowired service.
     *
     * @return \App\Repository\HelpDeskTicketRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HelpDeskTicketRepository.php';

        return $container->privates['App\\Repository\\HelpDeskTicketRepository'] = new \App\Repository\HelpDeskTicketRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
