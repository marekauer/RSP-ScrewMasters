 ...
 */
class getPublicatedSubmissionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PublicatedSubmissionRepository' shared autowired service.
     *
     * @return \App\Repository\PublicatedSubmissionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PublicatedSubmissionRepository.php';

        return $container->privates['App\\Repository\\PublicatedSubmissionRepository'] = new \App\Repository\PublicatedSubmissionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
