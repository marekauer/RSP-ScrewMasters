 ...
 */
class getPublicationCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PublicationCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\PublicationCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PublicationCategoryRepository.php';

        return $container->privates['App\\Repository\\PublicationCategoryRepository'] = new \App\Repository\PublicationCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
