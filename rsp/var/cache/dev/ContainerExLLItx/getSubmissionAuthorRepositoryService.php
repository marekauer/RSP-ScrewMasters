 ...
 */
class getSubmissionAuthorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubmissionAuthorRepository' shared autowired service.
     *
     * @return \App\Repository\SubmissionAuthorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubmissionAuthorRepository.php';

        return $container->privates['App\\Repository\\SubmissionAuthorRepository'] = new \App\Repository\SubmissionAuthorRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
