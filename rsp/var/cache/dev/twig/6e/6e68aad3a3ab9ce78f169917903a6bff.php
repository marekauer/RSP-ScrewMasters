...
class __TwigTemplate_9d51bd3a6f341f6fb732a4a7d85f2a41 extends Template
{
    ...
    <form method=\"post\">
        ...
        // line 17
        yield "
        <span class=\"h3 mb-3 font-weight-normal\">Přihlášení</span>
        <br>
...
";
    ...
    {
        return array (  140 => 24,  134 => 21,  128 => 17,  120 => 14,  117 => 13,  115 => 12,  112 => 11,  106 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"wrapper\">
    <form method=\"post\">
        ...
        {% if app.user %}
            <div class=\"mb-3\">
                Jste přihášen/a jako {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Odhlásit se</a>
            </div>
        {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Uživatel\\Desktop\\Programing\\VŠPJ\\RSP\\RSP-ScrewMasters\\rsp\\templates\\security\\login.html.twig");
    }
}
